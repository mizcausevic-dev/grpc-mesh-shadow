...
### Released
- Published **grpc-mesh-shadow** as a public, portfolio-grade system focused on platform governance.
...
### Shipped
- Cut the first coherent internal version of **grpc-mesh-shadow** with stable domain objects, review surfaces, and decision outputs.
